...
export default function CosmosCanvas() {
  ...
  const [stats, setStats] = useState({ particleCount: 0, starCount: 0, planetCount: 0, habitableCount: 0, totalPopulation: 0, isSparked: false, timeSinceSpark: 0 });
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#050505]">
      <canvas
        ...
        className={`absolute inset-0 z-0 ${!stats.isSparked ? 'cursor-crosshair' : 'cursor-default'}`}
      />
